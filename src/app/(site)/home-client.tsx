            ...
            {fanItems.map(({ m, tilt }, i) => {
              ...
              return (
                <li
                  ...
                  className="relative w-[7.2rem] shrink-0 origin-bottom rotate-(--tilt) transition-all duration-200 ease-out hover:z-20 hover:rotate-0 hover:-translate-y-2 sm:w-[8.4rem]"
                >
                  <button
                    type="button"
